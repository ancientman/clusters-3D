function [adjustFilledNucLabelMat, hollowLabelMat, nucFilledProp] = timeAdjustNucLabeler3(filledMask, hollowHull, primeHollowLabelMat, metaDataDS, t)
...
%         hollowHull(hollowCC.PixelIdxList{orphanHollowLabels}) = 0;
...
[nucFilledProp] = Nucleus.nucProp3(bwconncomp(adjustFilledNucMask), adjustFilledNucMask, metaDataDS);
end
